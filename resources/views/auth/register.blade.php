            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email2" class="col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="key" class="col-md-4 col-form-label text-md-end">{{ __('Device Key') }}</label>

                            <div class="col-md-6">
                                <input id="key" type="key" class="form-control @error('key') is-invalid @enderror" name="key" value="{{ old('key') }}" required autocomplete="key">
                        ...
                        <div class="row mb-3">
                            <label for="password2" class="col-md-4 col-form-label text-md-end">{{ __('Password') }}</label>
