    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h3 class="d-flex align-items-center m-0 text-primary">Empleados</h3>
                    ...
                    <tbody>
                        <tr v-for="user in usuarios">
                            ...
                            <td class="d-flex justify-content-around">
                                <button class="btn btn-outline-dark" @click="eliminar(user)" title="Informacion"><i class="fa fa-info"></i></button>
                ...
                <form method="post">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Nombre del empleados"
...
import * as alertas from '../alertas';
    ...
    export default {
        ...
        methods: {
            ...
            getUser(){
                axios.get('listar_disps').then(res => {
